...
| Family | Styles | Usage |
|--------|--------|-------|
| **MonoOS Sans** | Thin–Black (9 weights), Regular + Italic | All UI text |
| **MonoOS Mono** | Regular, Medium, Bold | Terminal, code editor, monospace labels |
...
```
MonoOSSans-<Weight>[Italic].ttf
MonoOSSono-<Weight>.ttf
```
...
MonoOS Sans and MonoOS Mono are proprietary to DudasCorp.
