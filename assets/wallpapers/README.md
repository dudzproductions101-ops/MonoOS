...
| `default_monoos_brand` | MonoOS Brand | Branded geometric | 3840×2400 |
...
`default_aurora` and `default_monoos_brand` are original works by DudasCorp,
