# MonoOS Build Toolchains

This directory contains toolchain descriptor files used by the MonoOS build
...
tarballs from the MonoOS build infrastructure CDN, verifies their SHA-256
