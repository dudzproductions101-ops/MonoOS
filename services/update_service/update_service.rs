//! update_service.rs – MonoOS UpdateService Service
//!
//! Downloads, verifies, and applies OTA updates to the inactive A/B slot using the payload_consumer protocol.
...
// ─────────────────────────────────────────────────────────────────────────────
//  UpdateServiceService implementation
// ─────────────────────────────────────────────────────────────────────────────

pub struct UpdateServiceService {
    status:   ServiceStatus,
    metadata: HashMap<String, String>,
}

impl UpdateServiceService {
    pub fn new() -> Self {
    ...
    pub fn start(&mut self) -> Result<()> {
        ...
        eprintln!("[update_service] service started");
        Ok(())
    }
    ...
    pub fn stop(&mut self) -> Result<()> {
        ...
        eprintln!("[update_service] service stopped");
        Ok(())
    }
    ...
    fn on_start(&mut self) -> Result<()> {
        ...
        self.metadata.insert("service".into(), "update_service".into());
        Ok(())
    }
...
impl Default for UpdateServiceService {
...
pub type SharedUpdateServiceService = Arc<Mutex<UpdateServiceService>>;

pub fn create() -> SharedUpdateServiceService {
    Arc::new(Mutex::new(UpdateServiceService::new()))
}
...
mod tests {
    ...
    #[test]
    fn start_and_stop() {
        let mut svc = UpdateServiceService::new();
    ...
    fn get_info_after_start() {
        let mut svc = UpdateServiceService::new();
        svc.start().unwrap();
        assert_eq!(svc.get_info("service"), Some("update_service"));
    }
}
