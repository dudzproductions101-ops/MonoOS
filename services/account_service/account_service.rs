//! account_service.rs – MonoOS AccountService Service
//!
//! Stores encrypted user account credentials, provides OAuth token refresh, and syncs account metadata.
...
// ─────────────────────────────────────────────────────────────────────────────
//  AccountServiceService implementation
// ─────────────────────────────────────────────────────────────────────────────

pub struct AccountServiceService {
    status:   ServiceStatus,
    metadata: HashMap<String, String>,
}

impl AccountServiceService {
    pub fn new() -> Self {
    ...
    pub fn start(&mut self) -> Result<()> {
        ...
        eprintln!("[account_service] service started");
        Ok(())
    }
    ...
    pub fn stop(&mut self) -> Result<()> {
        ...
        eprintln!("[account_service] service stopped");
        Ok(())
    }
    ...
    fn on_start(&mut self) -> Result<()> {
        ...
        self.metadata.insert("service".into(), "account_service".into());
        Ok(())
    }
...
impl Default for AccountServiceService {
...
pub type SharedAccountServiceService = Arc<Mutex<AccountServiceService>>;

pub fn create() -> SharedAccountServiceService {
    Arc::new(Mutex::new(AccountServiceService::new()))
}
...
mod tests {
    ...
    #[test]
    fn start_and_stop() {
        let mut svc = AccountServiceService::new();
    ...
    fn get_info_after_start() {
        let mut svc = AccountServiceService::new();
        svc.start().unwrap();
        assert_eq!(svc.get_info("service"), Some("account_service"));
    }
}
