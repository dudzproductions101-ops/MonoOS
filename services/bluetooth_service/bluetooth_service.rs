//! bluetooth_service.rs – MonoOS BluetoothService Service
//!
//! Controls the Bluetooth daemon (BlueZ), manages paired devices, A2DP/HFP/BLE profile dispatch.
...
// ─────────────────────────────────────────────────────────────────────────────
//  BluetoothServiceService implementation
// ─────────────────────────────────────────────────────────────────────────────

pub struct BluetoothServiceService {
    status:   ServiceStatus,
    metadata: HashMap<String, String>,
}

impl BluetoothServiceService {
    pub fn new() -> Self {
        BluetoothServiceService {
    ...
    pub fn start(&mut self) -> Result<()> {
        ...
        eprintln!("[bluetooth_service] service started");
        Ok(())
    }
    ...
    pub fn stop(&mut self) -> Result<()> {
        ...
        eprintln!("[bluetooth_service] service stopped");
        Ok(())
    }
    ...
    fn on_start(&mut self) -> Result<()> {
        ...
        self.metadata.insert("service".into(), "bluetooth_service".into());
        Ok(())
    }
...
impl Default for BluetoothServiceService {
...
pub type SharedBluetoothServiceService = Arc<Mutex<BluetoothServiceService>>;

pub fn create() -> SharedBluetoothServiceService {
    Arc::new(Mutex::new(BluetoothServiceService::new()))
}
...
mod tests {
    ...
    #[test]
    fn start_and_stop() {
        let mut svc = BluetoothServiceService::new();
    ...
    fn get_info_after_start() {
        let mut svc = BluetoothServiceService::new();
        svc.start().unwrap();
        assert_eq!(svc.get_info("service"), Some("bluetooth_service"));
    }
}
