//! settings_service.rs – MonoOS SettingsService Service
//!
//! Persistent key-value store for system and per-user settings. Notifies observers of changes.
...
// ─────────────────────────────────────────────────────────────────────────────
//  SettingsServiceService implementation
// ─────────────────────────────────────────────────────────────────────────────

pub struct SettingsServiceService {
    status:   ServiceStatus,
    metadata: HashMap<String, String>,
}

impl SettingsServiceService {
    pub fn new() -> Self {
    ...
    pub fn start(&mut self) -> Result<()> {
        ...
        eprintln!("[settings_service] service started");
        Ok(())
    }
    ...
    pub fn stop(&mut self) -> Result<()> {
        ...
        eprintln!("[settings_service] service stopped");
        Ok(())
    }
    ...
    fn on_start(&mut self) -> Result<()> {
        ...
        self.metadata.insert("service".into(), "settings_service".into());
        Ok(())
    }
...
impl Default for SettingsServiceService {
...
pub type SharedSettingsServiceService = Arc<Mutex<SettingsServiceService>>;

pub fn create() -> SharedSettingsServiceService {
    Arc::new(Mutex::new(SettingsServiceService::new()))
}
...
mod tests {
    ...
    #[test]
    fn start_and_stop() {
        let mut svc = SettingsServiceService::new();
    ...
    fn get_info_after_start() {
        let mut svc = SettingsServiceService::new();
        svc.start().unwrap();
        assert_eq!(svc.get_info("service"), Some("settings_service"));
    }
}
