//! network_service.rs – MonoOS NetworkService Service
//!
//! Manages Wi-Fi, cellular data, VPN connections, and enforces per-app network policies via the kernel netfilter module.
...
// ─────────────────────────────────────────────────────────────────────────────
//  NetworkServiceService implementation
// ─────────────────────────────────────────────────────────────────────────────

pub struct NetworkServiceService {
    status:   ServiceStatus,
    metadata: HashMap<String, String>,
}

impl NetworkServiceService {
    pub fn new() -> Self {
    ...
    pub fn start(&mut self) -> Result<()> {
        ...
        eprintln!("[network_service] service started");
        Ok(())
    }
    ...
    pub fn stop(&mut self) -> Result<()> {
        ...
        eprintln!("[network_service] service stopped");
        Ok(())
    }
    ...
    fn on_start(&mut self) -> Result<()> {
        ...
        self.metadata.insert("service".into(), "network_service".into());
        Ok(())
    }
...
impl Default for NetworkServiceService {
...
pub type SharedNetworkServiceService = Arc<Mutex<NetworkServiceService>>;

pub fn create() -> SharedNetworkServiceService {
    Arc::new(Mutex::new(NetworkServiceService::new()))
}
...
mod tests {
    ...
    #[test]
    fn start_and_stop() {
        let mut svc = NetworkServiceService::new();
    ...
    fn get_info_after_start() {
        let mut svc = NetworkServiceService::new();
        svc.start().unwrap();
        assert_eq!(svc.get_info("service"), Some("network_service"));
    }
}
