//! storage_service.rs – MonoOS StorageService Service
//!
//! Manages partition mounting, external storage permissions, Media Store indexing, and quota enforcement.
...
// ─────────────────────────────────────────────────────────────────────────────
//  StorageServiceService implementation
// ─────────────────────────────────────────────────────────────────────────────

pub struct StorageServiceService {
    status:   ServiceStatus,
    metadata: HashMap<String, String>,
}

impl StorageServiceService {
    pub fn new() -> Self {
    ...
    pub fn start(&mut self) -> Result<()> {
        ...
        eprintln!("[storage_service] service started");
        Ok(())
    }
    ...
    pub fn stop(&mut self) -> Result<()> {
        ...
        eprintln!("[storage_service] service stopped");
        Ok(())
    }
    ...
    fn on_start(&mut self) -> Result<()> {
        ...
        self.metadata.insert("service".into(), "storage_service".into());
        Ok(())
    }
...
impl Default for StorageServiceService {
...
pub type SharedStorageServiceService = Arc<Mutex<StorageServiceService>>;

pub fn create() -> SharedStorageServiceService {
    Arc::new(Mutex::new(StorageServiceService::new()))
}
...
mod tests {
    ...
    #[test]
    fn start_and_stop() {
        let mut svc = StorageServiceService::new();
    ...
    fn get_info_after_start() {
        let mut svc = StorageServiceService::new();
        svc.start().unwrap();
        assert_eq!(svc.get_info("service"), Some("storage_service"));
    }
}
