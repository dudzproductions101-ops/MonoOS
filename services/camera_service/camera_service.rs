//! camera_service.rs – MonoOS CameraService Service
//!
//! Arbitrates access to camera hardware, manages concurrent camera sessions, applies privacy restrictions, and interfaces with the V4L2 HAL.
...
// ─────────────────────────────────────────────────────────────────────────────
//  CameraServiceService implementation
// ─────────────────────────────────────────────────────────────────────────────

pub struct CameraServiceService {
    status:   ServiceStatus,
    metadata: HashMap<String, String>,
}

impl CameraServiceService {
    pub fn new() -> Self {
    ...
    pub fn start(&mut self) -> Result<()> {
        ...
        eprintln!("[camera_service] service started");
        Ok(())
    }
    ...
    pub fn stop(&mut self) -> Result<()> {
        ...
        eprintln!("[camera_service] service stopped");
        Ok(())
    }
    ...
    fn on_start(&mut self) -> Result<()> {
        ...
        self.metadata.insert("service".into(), "camera_service".into());
        Ok(())
    }
...
impl Default for CameraServiceService {
...
pub type SharedCameraServiceService = Arc<Mutex<CameraServiceService>>;

pub fn create() -> SharedCameraServiceService {
    Arc::new(Mutex::new(CameraServiceService::new()))
}
...
mod tests {
    ...
    #[test]
    fn start_and_stop() {
        let mut svc = CameraServiceService::new();
    ...
    fn get_info_after_start() {
        let mut svc = CameraServiceService::new();
        svc.start().unwrap();
        assert_eq!(svc.get_info("service"), Some("camera_service"));
    }
}
