//! audio_service.rs – MonoOS AudioService Service
//!
//! Routes audio streams between apps and the HAL, manages audio focus, volume policies, and Bluetooth A2DP/HFP profile switching.
...
// ─────────────────────────────────────────────────────────────────────────────
//  AudioServiceService implementation
// ─────────────────────────────────────────────────────────────────────────────

pub struct AudioServiceService {
    status:   ServiceStatus,
    metadata: HashMap<String, String>,
}

impl AudioServiceService {
    pub fn new() -> Self {
        AudioServiceService {
    ...
    pub fn start(&mut self) -> Result<()> {
        ...
        eprintln!("[audio_service] service started");
        Ok(())
    }
    ...
    pub fn stop(&mut self) -> Result<()> {
        ...
        eprintln!("[audio_service] service stopped");
        Ok(())
    }
    ...
    fn on_start(&mut self) -> Result<()> {
        ...
        self.metadata.insert("service".into(), "audio_service".into());
        Ok(())
    }
...
impl Default for AudioServiceService {
...
pub type SharedAudioServiceService = Arc<Mutex<AudioServiceService>>;

pub fn create() -> SharedAudioServiceService {
    Arc::new(Mutex::new(AudioServiceService::new()))
}
...
mod tests {
    ...
    #[test]
    fn start_and_stop() {
        let mut svc = AudioServiceService::new();
    ...
    fn get_info_after_start() {
        let mut svc = AudioServiceService::new();
        svc.start().unwrap();
        assert_eq!(svc.get_info("service"), Some("audio_service"));
    }
}
