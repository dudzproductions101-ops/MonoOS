//! package_service.rs – MonoOS PackageService Service
//!
//! Installs, removes, and updates application packages. Verifies APK signatures and enforces install-time permissions.
...
// ─────────────────────────────────────────────────────────────────────────────
//  PackageServiceService implementation
// ─────────────────────────────────────────────────────────────────────────────

pub struct PackageServiceService {
    status:   ServiceStatus,
    metadata: HashMap<String, String>,
}

impl PackageServiceService {
    pub fn new() -> Self {
    ...
    pub fn start(&mut self) -> Result<()> {
        ...
        eprintln!("[package_service] service started");
        Ok(())
    }
    ...
    pub fn stop(&mut self) -> Result<()> {
        ...
        eprintln!("[package_service] service stopped");
        Ok(())
    }
    ...
    fn on_start(&mut self) -> Result<()> {
        ...
        self.metadata.insert("service".into(), "package_service".into());
        Ok(())
    }
...
impl Default for PackageServiceService {
...
pub type SharedPackageServiceService = Arc<Mutex<PackageServiceService>>;

pub fn create() -> SharedPackageServiceService {
    Arc::new(Mutex::new(PackageServiceService::new()))
}
...
mod tests {
    ...
    #[test]
    fn start_and_stop() {
        let mut svc = PackageServiceService::new();
    ...
    fn get_info_after_start() {
        let mut svc = PackageServiceService::new();
        svc.start().unwrap();
        assert_eq!(svc.get_info("service"), Some("package_service"));
    }
}
