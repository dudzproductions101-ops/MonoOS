//! trust_store.rs – Immutable trust anchor store for MonoOS Verified Boot
//!
...
pub struct TrustAnchor {
    /// Human-readable label (e.g. "MonoOS OEM Root CA 1").
...
/// Placeholder DER bytes for the MonoOS development root CA.
...
/// The built-in trust anchors for MonoOS.
pub static BUILTIN_ANCHORS: &[TrustAnchor] = &[
    TrustAnchor::builtin(
        "MonoOS OEM Root CA 1 (DEV – REPLACE)",
        OEM_ROOT_CA_DER,
