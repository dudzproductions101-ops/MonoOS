/*
 * boot.h – OneOS bootloader public types and declarations
 *
...
/* ------------------------------------------------------------------ */
#define ONEOS_BOOTLOADER_VERSION_MAJOR  1
#define ONEOS_BOOTLOADER_VERSION_MINOR  0
#define ONEOS_BOOTLOADER_VERSION_PATCH  0
