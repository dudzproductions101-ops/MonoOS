//! recovery_main.rs – OneOS recovery environment entry point
//!
...
//!
//! This module is compiled as part of the `oneos-recovery` binary that
...
#[no_mangle]
pub unsafe extern "C" fn oneos_recovery_main(recovery_arg: *const u8) -> i32 {
