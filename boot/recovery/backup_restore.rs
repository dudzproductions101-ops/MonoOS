...
//!
//! Provides a lightweight backup format (MonoOS Backup Archive, `.oba`)
//! compatible with the MonoOS backup service.  In recovery, backups
...
pub struct BackupMetadata {
    ...
    pub created_at:    u64,
    /// MonoOS version string at time of backup (e.g. "1.2.0").
...
impl BackupRestoreManager {
    pub fn new() -> Self {
        ...
        mgr.add_backup_dir("/sdcard/MonoOS/backups");
    ...
    pub fn restore_latest(&self) -> Result<(), &'static str> {
        ...
        self.restore_from_path("/sdcard/MonoOS/backups/latest.oba", BackupContent::default())
    }
    ...
    fn relabel_restored_files(&self) -> Result<(), &'static str> {
        ...
        // On MonoOS this calls the security framework relabelling service.
        Ok(())
    }
