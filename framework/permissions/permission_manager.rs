//! permission_manager.rs – OneOS Framework Permission Manager
//!
...
//! via the OneOS SDK; it validates the request, persists the user's
//! decision, and calls sys_oneos_perm_set.
...
impl PermissionManager {
    ...
    pub fn apply_grant(
        ...
        unsafe {
            // sys_oneos_perm_set(pid, perm.kernel_bit(), val)
