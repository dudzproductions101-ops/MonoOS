//! app_context.rs – OneOS Application Context
//!
//! Every OneOS application receives an AppContext on startup.  It is the
...
mod tests {
    ...
    fn shared_prefs_set_get() {
        ...
        let ctx_dir = std::env::temp_dir().join("oneos_test_prefs");
