//! repo_manager.rs – MonoOS Package Repository Manager
//!
...
impl RepoManager {
    pub fn new() -> Self {
        ...
        // Default repo: MonoOS official.
        mgr.add_repo(Repository::new("monoos-official", "MonoOS Official", "https://packages.monoos.io/stable"));
        mgr
    }
