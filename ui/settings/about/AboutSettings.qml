// AboutSettings.qml – About OneOS device information page
import QtQuick 2.15
...
Page {
    ...
    ScrollView {
        ...
        Column {
            ...
            // OneOS logo / version hero
            Rectangle {
                width: parent.width; height: 220
                color: ThemeEngine.surface
                Column {
                    anchors.centerIn: parent; spacing: 12
                    Text { text: "OneOS"; font { pixelSize: 42; weight: Font.Thin }; color: ThemeEngine.labelPrimary; anchors.horizontalCenter: parent.horizontalCenter }
